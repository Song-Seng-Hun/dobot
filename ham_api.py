...
class RobotUI(object):
    ...
    def __init__(self):
        ...
        # fixed window size
        self.root.geometry("900x850")  # disabled by ham
        # self.root.geometry("900x1500") #ham
        # set window icon
        ...
        ip_port = StringVar(self.root, value="192.168.1.6")  # disabled by ham
        # ip_port = StringVar(self.root, value="192.168.235.6") #ham
        ...
        # get_pose (ham)
        # self.button_get_pose = self.set_button(master=self.frame_robot,
        #                                       text="get_pose", rely=0.6, x=750, command=self.ham_get_pose)
        # self.button_get_pose["width"] = 10
        # self.global_state["get_pose"] = False
        ...
        i_value = IntVar(self.root, value="2")
        ...
        # <ham>
        self.set_button(master=self.frame_move,
                        text="ham_move_test", rely=0.45, x=500, command=self.ham_move_test)
        # </ham>
    ...
    def connect_port(self):
        ...
        self.set_feed_back()  # disabled by ham
    ...
    def ham_get_pose(self):
        get_pose_result = self.client_dash.GetPose()
        print(get_pose_result)

    def ham_move_test(self):
    ...
    def ham_move1(self):
        move_test_result1 = self.client_move.JointMovJ(
            77.032,
            70.424,
            92.77,
            128.502
        )
        # print(move_test_result1)
        return move_test_result1

    def ham_move2(self):
        move_test_result2 = self.client_move.JointMovJ(
            136.899,
            9.587,
            56.477,
            128.513
        )
        # print(move_test_result2)
        return move_test_result2

    def ham_move3(self):
        move_test_result3 = self.client_move.JointMovJ(
            136.864,
            59.315,
            76.295,
            128.524
        )
        # print(move_test_result3)
        return move_test_result3

    def ham_move_coord(self):
        move_test_result4 = self.client_move.MovJ(
            255.764800,
            -54.340369,
            -4.860115,
            1.282146,
        ...
        # print(move_test_result1)
        return move_test_result4

    def ham_move_coord2(self):
        move_test_result5 = self.client_move.MovJ(
            261.789778,
            41.328535,
            13.614199,
            22.278387,
        ...
        # print(move_test_result1)
        return move_test_result5

    def move_ready(self):
        result_move_ready = self.client_move.MovJ(
            129.796103,
            225.926990,
            -5.210310,
            73.154968
